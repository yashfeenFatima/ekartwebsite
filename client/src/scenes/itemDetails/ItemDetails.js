...
const ItemDetails = () => {
    ...
    async function getItem() {
        ...
        console.log("Item received: ", itemJson.data)
    ...
    // console.log("Description:", item?.attributes?.longDescription);
    ...
    return <Box width="80%" m="80px auto">
        ...
        <Box display="flex" flexWrap="wrap" columnGap="40px">
            ...
            <Box flex="1 1 50%" mb="40px">
                ...
                <Box m="65px 0 25px 0">
                    <Typography variant="h3"> {item?.attributes?.name || 'No Name Available'}</Typography>
                    <Typography>${item?.attributes?.price || "0.00"}</Typography>
                    <Typography sx={{ mt: "20px" }}>
                        {Array.isArray(item?.attributes?.longDescription) && item?.attributes?.longDescription.length > 0
